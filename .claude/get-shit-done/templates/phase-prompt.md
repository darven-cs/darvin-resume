...
<!-- For checkpoint task examples and patterns, see @/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
