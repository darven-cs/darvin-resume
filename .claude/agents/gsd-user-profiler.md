...
<reference>
@/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/references/user-profiling.md` to load:
