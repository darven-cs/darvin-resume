...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/darven/桌面/dev_app/darvin-resume/.claude
                  → checks /home/darven/桌面/dev_app/darvin-resume/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done
                  → writes to /home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/darven/桌面/dev_app/darvin-resume/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
