...
- [ ] 03-05: 一键解析旧简历、职位目标上下文、全文上下文开关
- [ ] 03-06: AI调用全场景异常兜底(网络/Token/格式/中断)
...
Plans:
- [ ] 04-01: 简历列表页 — 列表展示、排序、搜索、重命名、复制、删除
- [ ] 04-02: AI引导式创建流程 — 模块勾选、分步填写、AI润色、完成生成
- [ ] 04-03: 空白页创建、回收站功能、自动保存机制
...
Plans:
- [ ] 05-01: 4套内置模板、模板切换机制、个人模板保存
- [ ] 05-02: 可视化样式调整、自定义CSS白名单、一键重置
- [ ] 05-03: PDF导出 — Wails系统打印、Chromedp备选、A4分页规则、导出参数
- [ ] 05-04: 版本快照管理 — 创建/自动创建、历史列表、Diff对比、回滚
