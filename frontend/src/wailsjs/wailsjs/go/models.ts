...
export namespace model {
	...
	export class DiffStats {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.changedLines = source["changedLines"];
	    }
	}
	export class DiffResult {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.snapshot1Id = source["snapshot1Id"];
	        this.snapshot2Id = source["snapshot2Id"];
	        this.snapshot1Label = source["snapshot1Label"];
	        this.snapshot2Label = source["snapshot2Label"];
	        this.contentDiff = source["contentDiff"];
	...
	export class SnapshotListItem {
	    ...
	    static createFrom(source: any = {}) {
	        return new SnapshotListItem(source);
	    }
